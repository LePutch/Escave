...
public class AutomataParser implements AutomataParserConstants {
	...
	public static int index_of_input(String[] args) {
		...
		int i = 0;
		while (i < args.length) {
			if ((args[i].equals("-ast") || args[i].equals("-string") || args[i].equals("-aut")
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * if ( option("-AST",args) ) { ASTPrinter ast_printer = new ASTPrinter();
		 * ast.accept(ast_printer);
		 * System.out.println("// THE AST of the PARSED AUTOMATA in DOT FORMAT \n");
		 * System.out.println(ast_printer.to_dot()); } if ( option("-AUT",args) ) {
		 * System.out.println("// THE AUTOMATA in DOT FORMAT \n"); AutomataPrinter v =
		 * new AutomataPrinter(); v.print(System.out, ast); }
		 */
...
// THE PARSER
	...
	/*
	 * Automaton | Identifier . "(" . Identifier . ")" . "{" . At_least.one_Mode .
	 * "}"
	 */
	...
	/*
	 * At_least.one_Mode | Mode . Some_Mode
	 */
	...
	/*
	 * Some_Mode | At_least.one_Mode | epsilon
	 */
	...
	/*
	 * Mode | "*" . State . Opt_TwoPoints . Behaviour
	 */
	...
	/*
	 * Transition | Opt_Bar . Condition . "?" . Opt_Action . ":" . State
	 */
	...
	/*
	 * Choices | Probabilistic_Action . Opt_More_Choices
	 */
	...
	/*
	 * Opt_More_Choices | <BINOP> . Choices | epsilon
	 */
	...
	/*
	 * Probabilistic_Action | Percent . ACTION . Opt_Parameters | ACTION .
	 * Opt_Parameters
	 */
	...
	/*
	 * Michael > OLD VERSION 7/04/2020 Opt_Action | ACTION . Opt_Parameters | ""
	 * 
	 * Action OLD_P_Opt_Action(): { Token token ; List<Parameter> parameters = new
	 * LinkedList<Parameter>() ; } { token = <ACTION> parameters = P_Opt_Parameters(
	 * parameters ) { return new Action(new FunCall(token.image, parameters)) ; } |
	 * //epsilon { return null; } }
	 */
	...
	/*
	 * FunCall | "Key(" . KeyName . ")" // Special case for the "Key" condition
	 * which has a fixed arity | CONDITION . Opt_Parameters
	 */
	...
	/*
	 * Parameters | Direction | Category | Integer
	 */
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x500, 0x100a00, 0x40000, 0x2000000, 0x140000, 0x4000000, 0x30210020, 0x10000000,
				0x80040, 0x20000, 0x80040, 0x20210020, 0x20000, 0x20000020, 0x182380, 0x200000, 0x180f00, 0x80000000,
				0x180f00, };
	}
